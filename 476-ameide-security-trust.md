...
- **Operator & EDA alignment:** Provides the security assumptions that operator and EDA backlogs (`473-ameide-technology.md`, `495-ameide-operators.md`, `496-eda-principles-v2.md`, `497-operator-implementation-patterns.md`, `498-domain-operator.md`, `499-process-operator.md`, `500-agent-operator.md`, `501-uisurface-operator.md`, `503-operators-helm-chart.md`) must respect when wiring workloads and events.  
