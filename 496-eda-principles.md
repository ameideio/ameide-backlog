...
> **Superseded:** The Kubernetes standard for inter-primitive messaging is now defined in `backlog/496-eda-principles-v6.md` (`io.ameide.*`, hybrid messaging; Kafka remains the standard event plane). This document is retained for historical context and legacy implementations.

**Status:** Superseded by `496-eda-principles-v6.md`
