...
| Promote environments | Workflow waits for promotion outcome (Signal/Update; timers once supported) | Facts: release/promote outcomes emitted by owning domain(s) | GitOps promotion is a Git change per `backlog/611-trunk-based-main-and-gitops-environment-promotion.md` | UI shows promotion timeline + PR links |
