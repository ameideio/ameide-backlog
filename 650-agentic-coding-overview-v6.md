---
title: "650 – Agentic coding (v6: internal-first, Coder-orchestrated) — overview"
status: active
owners:
  - platform-devx
  - platform
...
supersedes:
  - 650-agentic-coding-overview.md
related:
  - 496-eda-principles-v6.md
  - 611-trunk-based-main-and-gitops-environment-promotion.md
  - 602-image-pull-policy.md
...
# 650 – Agentic coding (v6: internal-first, Coder-orchestrated) — overview
...
## 0.2 Scope boundary (v6; avoid cross-suite confusion)

This suite is about **agentic development of the Ameide platform codebase** (GitHub PRs, Coder workspaces/tasks, `ameide test` front doors).

It is distinct from the v6 “Enterprise Repository” posture used by the Transformation capability:

- Enterprise Repository UI and Git-tree semantics: `backlog/701-repository-ui-enterprise-repository-v6.md`
- Git-backed tenant repo posture (in-cluster GitLab, CE-only): `backlog/694-elements-gitlab-v6.md`
- Agentic memory over tenant repos (projection-owned retrieval + citations): `backlog/656-agentic-memory-v6.md`

The two systems share governance shape (“proposal → review → publish”), but they do **not** share identifiers or storage backends (GitHub PRs vs GitLab MRs).
...
- `backlog/650-agentic-coding-overview-v6.md` (this file; normative)
