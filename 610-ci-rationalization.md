...
- **Update (2026-01-20):** `ameide test` is now the canonical Phase 0/1/2 gate (local-only) and cluster-only verification is split into explicit `ameide test cluster` (Phase 4/5; PRs: `ameideio/ameide#582`, `ameideio/ameide#589`).
