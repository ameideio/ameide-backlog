...
- Data extended: 400–499
  ...
  - 420: operators/controllers (temporal operator; depends on cert-manager CA injection in its namespace)
  ...
  - 455: post-runtime bootstraps (Jobs/CRs that must talk to the running cluster; Temporal namespaces are now `TemporalNamespace` CRs alongside `data-temporal`)
