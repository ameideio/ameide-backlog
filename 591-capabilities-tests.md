...
- Process:
  - requests work (domain intent), waits via explicit workflow waits (message/timer) plus Activity results, emits process facts (`ToolRunRecorded`, `GateDecisionRecorded`, etc.)
