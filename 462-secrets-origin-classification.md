...
**Implemented (2025-12-07):** The client-patcher Job extracts Keycloak-generated secrets for configured clients.

For runtime Keycloak clients, the implemented flow is:

| Secret | Client | Realm | Status |
|--------|--------|-------|--------|
| `platform-app-client-secret` | `platform-app` | `ameide` | ✅ Implemented |
| `platform-app-master-client-secret` | `platform-app-master` | `master` | ✅ Implemented |
| `argocd-dex-client-secret` | `argocd` | `ameide` | ✅ Implemented |
| `k8s-dashboard-oidc-client-secret` | `k8s-dashboard` | `ameide` | ✅ Implemented (client may not exist yet) |
