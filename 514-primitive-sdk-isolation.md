...
- **Unified primitive workflow:** `backlog/671-primitive-development-workflow-unified.md` (canonical end-to-end workflow and enforcement split).
...
- **Go (Domain/Process)**
  - The scaffolder derives Go import paths for service types from the proto path via `deriveImportPath`, mapping `packages/ameide_core_proto/src/...` to `github.com/ameideio/ameide-sdk-go/proto/...`.
