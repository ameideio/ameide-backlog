...
> | Document | Purpose |
> |----------|---------|
> | [465-applicationset-architecture.md](465-applicationset-architecture.md) | How data-temporal app is generated by ameide ApplicationSet |
> | [447-waves-v3-cluster-scoped-operators.md](447-waves-v3-cluster-scoped-operators.md) | Rollout phases 310-355 (platform layer), 450-455 (temporal runtime) |
> | [464-chart-folder-alignment.md](464-chart-folder-alignment.md) | Chart location (`sources/charts/third_party/temporal/`) |
> | [426-keycloak-config-map.md](426-keycloak-config-map.md) | CNPG credential patterns (§3.2 applies to Temporal DB creds) |
>
> **Related Runbooks**:
