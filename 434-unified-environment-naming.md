...
| **MIGRATE-6** | ✅ Complete | Contexts configured via `tools/dev/bootstrap-contexts.sh` (typically run manually due to interactive `az login`, or automatically when `AMEIDE_AUTO_BOOTSTRAP=1`). |
