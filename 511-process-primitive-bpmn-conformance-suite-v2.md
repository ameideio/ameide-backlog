...
- Run the conformance suite as a Kubernetes Job in the dev namespace (same network + auth as the platform) and make it part of the repo cluster smoke front door (`ameide test cluster`).
