...
- ⚠️ Service catalog coverage still lags: `service_catalog/agents/` only contains the generic `_primitive/template.yaml`, so Backstage cannot yet scaffold LangGraph coder runtimes directly.
