...
- **EDA and infra alignment:** Binds infra choices (CNPG, Envoy/Gateway, ExternalSecrets, Vault, Temporal) to the EDA and proto-chain rules further detailed in `472-ameide-information-application.md` and `496-eda-principles-v2.md`.  
