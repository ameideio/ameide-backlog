...
- **Classify by state ownership, not by producer.** A UISurface/Agent can emit a Domain intent; a Process primitive can emit a Process fact; classification is about whose state changes or is being asserted (`backlog/496-eda-principles-v6.md`).
