...
| **Process primitive**                    | `hr-workforce-jml-process`                            | Join/Move/Leave orchestration (Temporal); retries/compensation; emits process facts                 | Consumes domain facts; emits `HrWorkforceProcessFact`                                |
